...
(1, 'SBI Bank', '351672718822'),
(2, 'HDFC Bank', '98262891719');
...
(0, 'Lorurem ', '2022-07-30', '<p style="margin: 0px 0px 15px; padding: 0px; text-align: justify; color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial;">Lorurem festival.</p><br class="Apple-interchange-newline">');
...
(1, 1, 1, 1, 1000, 1, 1, '2018-05-02', 'Unpaid'),
(2, 1, 1, 1, 3000, 1, 2, '2018-05-03', 'Unpaid');
...
(0, 'Nrupatunga', 'Available'),
(1, 'Shalmala', 'Available');
...
(0, 'Lorurem ', '2022-07-30', 'To inform all the students about the Lorurem  Event which is going to be held on school premises. All the students are requested to take part in different activities. For more details contact RTE.', 'admin');
...
(1, 1, 'Half fees-15000', '15000.00'),
(0, 2, 'All fees-25000', '25000.00');
...
(1, 'Abhay Ambekar', 'Male', '1916-01-18', '12.jpg', 'IEBC/2017', 1, 2, 1, '2018-05-02', NULL, 1, 1, 10500, 500, NULL),
(0, 'Nidhi Mamdapur', 'Female', '1996-02-05', '12.jpg', '852', 0, 2, 1, '2018-07-30', 0, 1, 1, 500, 3500, 0),
(0, 'Naresh Illur', 'Male', '1997-04-17', '12.jpg', '123', 0, 2, 0, '2018-07-30', 0, 1, 0, 5000, 3500, 0),
(0, 'Disha R', 'Female', '1996-03-16', '12.jpg', '80', 0, 1, 1, '2018-07-30', 0, 1, 1, 6000, 3500, 0),
(0, 'Rupal Patel', 'Female', '1996-12-18', '12.jpg', '366', 0, 2, 1, '2018-07-30', 0, 1, 1, 2000, 3500, 0),
(0, 'Khushi T', 'Female', '1996-09-15', '12.jpg', '852', 0, 2, 0, '2018-07-30', 0, 1, 0, 1500, 13500, 0);
...
(0, 'Devang Shastri', 'Male', 29, '7531598522', 'shastri@gmail.com', 12),
(0, 'Benedict Cumberbatch', 'Male', 33, '1597534560', 'iambenedict@mail.com', 13);
